...
public class ModelTest {
    public static void main (String[] args){
        ...
        String ip = "localhost";
        int port = 2345;
        Model scrabbleModel = new Model(GameMode.Host, ip, port, "Yuval");
        ...
        Model guestModel = new Model(GameMode.Guest, ip, port, "Lior");
        ...
        System.out.println("Model guest! -> " + guestModel);
